...
;;; Commentary:
;;
;; This package defines several extra commands for 
  ...
  (when latex/clean-up-whitespace
    (save-excursion
      ...
      (let ((l (region-beginning))
            (r (region-end)))
        (unless (eq latex/clean-up-whitespace 'lines) (lsp/replace-regexp "  +" " " nil l r))
        (unless (eq latex/clean-up-whitespace 'spaces) (lsp/replace-regexp "\n\n\n+" "\n\n" nil l r)))))
